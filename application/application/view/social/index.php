                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="container">
                            ...
                            <form role="form" action="<?php echo URL . 'social/addsocialmedia/' . $_SESSION["staffid"]; ?>" method="POST">
                                ...
                                <table>
                                    ...
                                    <?php foreach ($platforms as $platform) { ?>
                                        <tr style="font-size:20px;">
                                            ...
                                            <td><a href="<?php echo URL . 'social/deletesocialmedia/' . $_SESSION["staffid"] . '/' . $platform->id; ?>">delete</a></td>
                                            <!--candidate fulfill the reference -->
                                            <td><a href="<?php echo URL . 'social/editsocialmedia/' . $_SESSION["staffid"] . '/' . $platform->id; ?>">edit</a></td>
                                            <!--candidate fulfill the reference -->
                                        </tr>
                                    <?php } ?>
                                    </tbody>
